...
import com.agrotech.agro_tech_system.application.usecase.alerta.ReabrirAlertaUseCase;
...
public class AlertaController {
    ...
    private final ReabrirAlertaUseCase reabrirAlerta;
    ...
    public ResponseEntity<Void> reabrir(@PathVariable String id) {
        reabrirAlerta.executar(id);
        return ResponseEntity.ok().build();
    }
}
